...
<body class="hold-transition login-page" style="background-image: url('dist/img/Leonardo_Phoenix_10_A_futuristic_hightech_illustration_of_a_sl_3.jpg'); /* The image used */
